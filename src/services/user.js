import { LOGIN, INFO, CONNECTTOKEN } from '@/services/api'
...
export async function user_paginate(params) {
  return request('/api/user/paginate', params || {}, METHOD.POST)
}
...
export async function user_edit(params) {
  return request('/api/user/edit', params || {}, METHOD.POST)
}
// 用户删除
...
export function user_get(params) {
  return request("/api/user/get", params || {}, METHOD.POST)
}

export function user_editinfo(params) {
  return request("/api/user/editinfo", params || {}, METHOD.POST)
}

export function user_editorganization(params) {
  return request("/api/user/editorganization", params || {}, METHOD.POST)
}

export function user_pullorganization(params) {
  return request("/api/user/pullorganization", params || {}, METHOD.POST)
}

export function user_pushorganization(params) {
  return request("/api/user/pushorganization", params || {}, METHOD.POST)
}

export function user_editpolicy(params) {
  return request("/api/user/editpolicy", params || {}, METHOD.POST)
}
export function user_editrole(params) {
  return request("/api/user/editrole", params || {}, METHOD.POST)
}
export function user_editpassword(params) {
  return request("/api/user/editpassword", params || {}, METHOD.POST)
}
// 重置密码
export async function reset_password(params) {
  return request('/api/user/resetpassword', params || {},METHOD.POST)
}

export function user_initusername(params) {
  return request("/api/user/initusername", params || {}, METHOD.POST)
}

export function user_initpassword(params) {
  return request("/api/user/initpassword", params || {}, METHOD.POST)
}
export function user_initmobile(params) {
  return request("/api/user/initmobile", params || {}, METHOD.POST)
}
export function user_initidentity(params) {
  return request("/api/user/initidentity", params || {}, METHOD.POST)
}

/** 错敏词校对 */
export function text_parser(params) {
  return request("/api/text/parser", params || {}, METHOD.POST)
}
