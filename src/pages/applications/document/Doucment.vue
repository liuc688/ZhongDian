                ...
                <a-tab-pane key="default" tab="基本信息">
                  <a-descriptions bordered>
                    ...
                    <a-descriptions-item
                      ...
                      :span="1"
                      v-if="
                        record.froms && record.froms.name && record.froms.url
                      "
                    >
                      {{ record.froms.name }}
                    </a-descriptions-item>
                    ...
                    <a-descriptions-item
                      label="图片"
                      :span="3"
                      v-if="record.logo && record.logo.length"
                    >
                      <a-card>
                        <template v-for="item in record.logo">
                          ...
                          >
                            <img
                              @click="onPicPreview(record.logo)"
                              :src="item.url"
                              height="80"
                    ...
                    <a-descriptions-item
                      label="关键字"
                      :span="3"
                      v-if="record.keyword && record.keyword.length"
                    >
                      <a-tag
                        color="blue"
                        v-for="(text, index) in record.keyword"
                        :key="index"
                      >
                        {{ text }}
                      </a-tag>
                    ...
                    <a-descriptions-item
                      ...
                      v-if="
                        record.relevance &&
                        record.relevance.files &&
                        record.relevance.files.length
                      "
                    >
                      <a-tag
                        color="blue"
                        v-for="item in record.relevance.files"
                        :key="item.uid"
                      >
                    ...
                    <a-descriptions-item
                      ...
                      v-if="
                        record.relevance &&
                        record.relevance.images &&
                        record.relevance.images.length
                      "
                    >
                      <a-card>
                        <template v-for="item in record.relevance.images">
                          ...
                          >
                            <img
                              @click="onPicPreview(record.relevance.images)"
                              :src="item.url"
                              height="80"
                    ...
                    <a-descriptions-item
                      ...
                      v-if="
                        record.relevance &&
                        record.relevance.videos &&
                        record.relevance.videos.length
                      "
                    >
                      <a-tag
                        color="blue"
                        v-for="item in record.relevance.videos"
                        :key="item.uid"
                      >
                    ...
                    <a-descriptions-item
                      ...
                      v-if="
                        record.relevance &&
                        record.relevance.pdfs &&
                        record.relevance.pdfs.length
                      "
                    >
                      <a-tag
                        color="blue"
                        v-for="item in record.relevance.pdfs"
                        :key="item.uid"
                      >
                        <a :href="item.url" target="_blank">{{ item.name }}</a>
                      </a-tag>
                    ...
                    <a-descriptions-item
                      ...
                      v-if="
                        record.relevance &&
                        record.relevance.words &&
                        record.relevance.words.length
                      "
                    >
                      <a-tag
                        color="blue"
                        v-for="item in record.relevance.words"
                        :key="item.uid"
                      >
                        <a :href="item.url" :download="item.name">{{
                          item.name
                    ...
                    <a-descriptions-item
                      ...
                      v-if="
                        record.relevance &&
                        record.relevance.relate &&
                        record.relevance.relate.length
                      "
                    >
                      <a-tag
                        color="blue"
                        v-for="(item, index) in record.relevance.relate"
                        :key="item.document"
                      >
                        <a @click="onRelateDocument(record)">{{
                          `相关文章${index + 1}`
                        }}</a>
                      </a-tag>
                    </a-descriptions-item>
                          ...
                          <a-descriptions :column="1" bordered size="small">
                            ...
                            <template v-for="flow in item.flows">
                              <a-descriptions-item :key="flow.id">
                                ...
                                <span>
                                  <a-tag v-if="flow.status">{{
                                    flow.lasttime
                                  }}</a-tag>
                                  <a-tag color="blue" v-if="flow.status == 0">
                                    待审核
                                  </a-tag>
                                  <a-tag
                                    color="green"
