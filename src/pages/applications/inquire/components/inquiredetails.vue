  ...
  <a-card :body-style="{ padding: '24px 32px' }" :bordered="false">
    ...
    >
      ...
      <span slot="action" slot-scope="text, record, index">
        <a v-if="record.answer == null" @click="reply(record, index)" >答复</a>
        <a v-else @click="reply(record, index)">编辑答复</a>
      </span>
    ...
    >
      <a-form-model-item
        ...
        :wrapper-col="{ span: 18 }"
      >
        <div class="title_back add_back ">{{ questions }}</div>
      </a-form-model-item>
