    ...
    <a-spin tip="Loading..." :spinning="loading">
      ...
      >
        <a-form-model-item label="组织机构代码" prop="code"
          ><a-input placeholder="组织机构代码" v-model="form.code"
        /></a-form-model-item>
        ...
        <a-form-model-item label="站点分类" prop="status">
          <a-select :default-value="0" v-model="form.status">
            <a-select-option :key="0">市本级</a-select-option>
            <a-select-option :key="1">县市区选此项</a-select-option>
            <a-select-option :key="2">市直部门、区直部门选此项</a-select-option>
            <a-select-option :key="3">企事业单位选此项</a-select-option>
            <a-select-option :key="4">镇街道选此项</a-select-option>
          </a-select>
        </a-form-model-item>
