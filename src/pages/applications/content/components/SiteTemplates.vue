    ...
    <a-spin tip="Loading..." :spinning="loading">
      ...
      >
        ...
        <a-form-model-item label="首页模版">
          <a-select v-model="form.home" placeholder="请选择目录模版" allowClear>
            <a-select-option
        ...
        <a-form-model-item label="目录模版">
          <a-select v-model="form.index" placeholder="请选择目录模版" allowClear>
            <a-select-option
              v-for="item in templates"
              :key="item.id"
              :value="item.id"
        ...
        <a-form-model-item label="文档模板">
          <a-select v-model="form.document" placeholder="请选择文档模板" allowClear>
            <a-select-option
              v-for="item in templates"
              :key="item.id"
              :value="item.id"
