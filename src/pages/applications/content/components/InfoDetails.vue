      ...
      <a-row>
        ...
        <a-col :xl="13" :lg="13">
          <div class="rights_pa">
            <a-space>
              <a-button>
                <a-checkbox @change="onRecycle">回收站</a-checkbox>
              </a-button>
              <a-button v-if="params.channel"
                ><a-checkbox @change="onFilter">过滤器</a-checkbox></a-button
              >
    ...
    >
      <span slot="_title" slot-scope="text, record">
        <div class="overflowhiddens">
          ...
          <template v-else>
            <template v-if="record.approved && !record.approved.status">
              <a-tooltip>
            ...
            <template
              v-else-if="record.approved && record.approved.status == 2"
            >
              <a-tooltip>
          ...
          >
            <!-- <a-tooltip placement="bottom">
              <template slot="title">
                ...
                <p>{{ record.source.site.title }} / {{ record.source.parent.title }}</p>
              </template>
            ...
            <a-popover>
              ...
              <div slot="content" class="doc_tags_conten">
                ...
                >
                  ...
                  <a-tag color="#87d068" v-if="record.site.id == item.site.id">抄送</a-tag>
      ...
      <span slot="parent" slot-scope="text, record">
        <template v-if="record.site == params.site">
